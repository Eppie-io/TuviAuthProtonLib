...
{
    public class AuthProtonException : AuthException
    {
        ...
        internal static void ThrowSystemException(string message, SystemException exception)
        {
            throw new AuthProtonException(message, exception);
        }
    }
}
